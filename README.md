...
- ✨ Passionate about **UI/UX Design** & **Health-Tech**  
- 🌱 Currently learning **C**, **JavaScript**, **Rust**, **Go**, **Ruby** 

 <img width="810" height="1080" alt="survivaldiaries" src="https://github.com/user-attachments/assets/8e43f2db-098b-4cf7-9622-e5b1281447eb" />


--- 

## 🛠 Tech Stack 
**Languages:** `Java` | `Python` | `HTML` | `CSS` |`C#` | `JavaScript`  
**Frameworks & Tools:** `React Native` | `Node.js` | `Figma` | `VS Code` | `WebStorm` | `GitHub`  
